...
def addOrMultiply(result,numbers,solutions):
    if solutions == []:
        ...
        concat_list = numbers.copy()
        first = concat_list[0]
        concat_list = concat_list[1:]
        concat_list[0] = int(str(first) + str(concat_list[0]))
        
        solutions.append(add_list)
        solutions.append(mul_list)
        solutions.append(concat_list)
        ...
        if len(solutions[0]) == 1:
            ...
            for solution in solutions:
                ...
                new_solutions.append(concat_list)
                # print(new_solutions)
